    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, help_text='If not linked to a contact', max_length=200)),
                ('email', models.EmailField(blank=True, max_length=254)),
                ('phone', models.CharField(blank=True, max_length=25)),
                ('source', models.CharField(choices=[('walk_in', 'Walk-in'), ('referral', 'Referral'), ('online', 'Online'), ('social', 'Social Media'), ('email', 'Email Campaign'), ('event', 'Event')], default='walk_in', max_length=20)),
